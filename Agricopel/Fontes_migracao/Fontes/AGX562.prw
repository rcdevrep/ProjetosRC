...
User Function AGX562() 
	...
	Private  aRotina   := { { "Imprimir" ,"U_AGX562_IMP()"  , 0, 1},;
    	                    { "Parâmetros" ,"U_ConfiguraPrt()"  , 0, 1}}  
    	                    
    	                    
 	//Spiller - Essa rotina foi substiruída por XAG0030  
 	If lDesabilit
 		Alert('Essa Rotina foi desabilitada, você deverá utilizar XAG0030 para impressão de Boletos Safra!')        
    	Return 
    Endif
...
Static Function CarregaDados()        
	...
	BeginSql Alias cAliasSF2  
			SELECT F2_DOC, F2_SERIE, F2_CLIENTE, F2_LOJA, F2_EMISSAO
			...
			E1_LOJA   = F2_LOJA AND 
			E1_PREFIXO = %xFilial:SF2%+Substring(LTRIM(F2_SERIE),1,3) AND 
			E1_NUM = F2_DOC AND 
		 	E1.%notdel%  
		 	//Fim
			WHERE                                                                                             
			...
			SF2.F2_LOJA    BETWEEN %Exp:mv_par08% AND %Exp:mv_par09% AND
	   		...
	   		GROUP BY F2_FILIAL, F2_DOC, F2_SERIE, F2_CLIENTE, F2_LOJA, F2_EMISSAO 
	   		//fim      
...
If cBanco == "422"
	cNomeCed := "AGRICOPEL COM.DE DERIV. PETROLEO "
Else
...
Else
oPrint:Say  (310,100 ,"PAGÁVEL EM QUALQUER BANCO ATÉ A DATA DO VENCIMENTO." ,oFont10)
Endif
...
If cBanco == "422"
	oPrint:Say  (410,100 ,"AGRICOPEL COM.DE DERIV. PETROLEO"          ,oFont10)
Else
	oPrint:Say  (410,100 ,aDadosEmp[1]          ,oFont10)
EndIf
	

oPrint:Say  (370,1910,"Agência/Código Cedente"                         ,oFont8) 
oPrint:Say  (410,2005,PadL(AllTrim(aDadosBanco[3]+"/"+aDadosBanco[4]+Iif(!Empty(aDadosBanco[5]),"-"+aDadosBanco[5],"")),16," "),oFont10)
...
Else
	oPrint:Say  (610,100 ,"Instruções/Texto de responsabilidade do cedente",oFont8)     
Endif
...
oPrint:Say  (988 ,210 ,aDatSacado[1]+" ("+aDatSacado[2]+")"             ,oFont8)
oPrint:Say  (1030 ,210 ,aDatSacado[3]                                    ,oFont8)
oPrint:Say  (1070 ,210 ,aDatSacado[6]+"  "+aDatSacado[4]+" - "+aDatSacado[5]+"         CGC/CPF: "+Iif(Len(AllTrim(aDatSacado[7]))==14,Transform(aDatSacado[7],"@R 99.999.999/9999-99"),Transform(aDatSacado[7],"@R 999.999.999-99")) ,oFont8)
...
oPrint:Say  (204,1850,"Recibo do Sacado"                              ,oFont10)
...
Else
oPrint:Say  (1430,100 ,"PAGÁVEL EM QUALQUER BANCO ATÉ A DATA DO VENCIMENTO."       ,oFont10)
Endif
...
If cBanco == "422"
	oPrint:Say  (1530,100 ,"AGRICOPEL COM.DE DERIV. PETROLEO "         ,oFont10) 
else
	oPrint:Say  (1530,100 ,aDadosEmp[1]                                     ,oFont10)
EndIf

oPrint:Say  (1490,1910,"Agência/Código Cedente"                         ,oFont8) 
oPrint:Say  (1530,2010,PadL(AllTrim(aDadosBanco[3]+"/"+aDadosBanco[4]+Iif(!Empty(aDadosBanco[5]),"-"+aDadosBanco[5],"")),16," "),oFont10)
...
Else
	oPrint:Say  (1730,100 ,"Instruções/Texto de responsabilidade do cedente",oFont8)
Endif
...
oPrint:Say  (2108,210 ,aDatSacado[1]+" ("+aDatSacado[2]+")"             ,oFont8)
oPrint:Say  (2148,210 ,aDatSacado[3]                                    ,oFont8)
oPrint:Say  (2188,210 ,aDatSacado[6]+"  "+aDatSacado[4]+" - "+aDatSacado[5]+"         CGC/CPF: "+Iif(Len(AllTrim(aDatSacado[7]))==14,Transform(aDatSacado[7],"@R 99.999.999/9999-99"),Transform(aDatSacado[7],"@R 999.999.999-99")) ,oFont8)
...
Elseif Substr(cBanco,1,3) == "2371" // Banco bradesco
	//Nosso Numero sem digito
...
Elseif Substr(cBanco,1,3) == "422" .or. Substr(cBanco,1,3) == "237"   // Banco Safra
	...
	nSoma1 := val(subs(StrZero(VAL(cNNumSDig),8),01,1))*9
	nSoma2 := val(subs(StrZero(VAL(cNNumSDig),8),02,1))*8
	nSoma3 := val(subs(StrZero(VAL(cNNumSDig),8),03,1))*7
	nSoma4 := val(subs(StrZero(VAL(cNNumSDig),8),04,1))*6
	nSoma5 := val(subs(StrZero(VAL(cNNumSDig),8),05,1))*5
	nSoma6 := val(subs(StrZero(VAL(cNNumSDig),8),06,1))*4
	nSoma7 := val(subs(StrZero(VAL(cNNumSDig),8),07,1))*3
	nSoma8 := val(subs(StrZero(VAL(cNNumSDig),8),08,1))*2
...
Static Function CriaSx1()
	Private cPerg      := "AX5626"

	PutSx1(cPerg, "01", "Nota    de      ?", "" , "", "mv_ch1", "C",TamSX3("F2_DOC")[1]  , 0, 2, 'G',"","","","", "mv_par01", "","", "","" ,"","","","","","","","","","","","", "","", "")     
	PutSx1(cPerg, "02", "Nota    ate     ?", "" , "", "mv_ch2", "C",TamSX3("F2_DOC")[1] , 0, 2, 'G',"","","","", "mv_par02", "","", "","" ,"","","","","","","","","","","","", "","", "")    
	PutSx1(cPerg, "03", "Serie           ?", "" , "", "mv_ch3", "C", 3 , 0, 2, 'G',"","","","", "mv_par03", "","", "","" ,"","","","","","","","","","","","", "","", "")
	PutSx1(cPerg, "04", "Emissao de      ?", "" , "", "mv_ch4", "D", 8 , 0, 2, 'G',"","","","", "mv_par04", "","", "","" ,"","","","","","","","","","","","", "","", "")		
	PutSx1(cPerg, "05", "Emissao ate     ?", "" , "", "mv_ch5", "D", 8 , 0, 2, 'G',"","","","", "mv_par05", "","", "","" ,"","","","","","","","","","","","", "","", "")		
	PutSx1(cPerg, "06", "Cliente de      ?", "" , "", "mv_ch6", "C", 6 , 0, 2, 'G',"","","","", "mv_par06", "","", "","" ,"","","","","","","","","","","","", "","", "")		
	PutSx1(cPerg, "07", "Cliente ate     ?", "" , "", "mv_ch7", "C", 6 , 0, 2, 'G',"","","","", "mv_par07", "","", "","" ,"","","","","","","","","","","","", "","", "")			
	PutSx1(cPerg, "08", "Loja    de      ?", "" , "", "mv_ch8", "C", 2 , 0, 2, 'G',"","","","", "mv_par08", "","", "","" ,"","","","","","","","","","","","", "","", "")			
	PutSx1(cPerg, "09", "Loja    ate     ?", "" , "", "mv_ch9", "C", 2 , 0, 2, 'G',"","","","", "mv_par09", "","", "","" ,"","","","","","","","","","","","", "","", "")		
	PutSx1(cPerg, "10", "Banco           ?", "" , "", "mv_ch10", "C", 3 , 0, 2, 'G',"","SA6","","", "mv_par10", "","", "","" ,"","","","","","","","","","","","", "","", "")		
	PutSx1(cPerg, "11", "Agencia         ?", "" , "", "mv_ch11", "C", 5 , 0, 2, 'G',"","","","", "mv_par11", "","", "","" ,"","","","","","","","","","","","", "","", "")			
	PutSx1(cPerg, "12", "Conta           ?", "" , "", "mv_ch12", "C", 10 , 0, 2, 'G',"","","","", "mv_par12", "","", "","" ,"","","","","","","","","","","","", "","", "")			
	PutSx1(cPerg, "13", "Sub-Conta       ?", "" , "", "mv_ch13", "C", 3 , 0, 2, 'G',"","","","", "mv_par13", "","", "","" ,"","","","","","","","","","","","", "","", "")			
	PutSx1(cPerg, "14", "Carteira        ?", "" , "", "mv_ch14", "C", 6 , 0, 2, 'G',"","","","", "mv_par14", "","", "","" ,"","","","","","","","","","","","", "","", "")				

...
If !dbSeek("NCCNDF")
	...
	/*
	aAdd(aRegs,{cPerg, 	"01","Nota de           ?", "", "", "mv_ch1", "C", 6, 00, 0, "G", "", "MV_PAR01", ""	, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "","", "", "", ""})
	aAdd(aRegs,{cPerg, 	"02","Nota ate          ?", "", "", "mv_ch2", "C", 6, 00, 0, "G", "", "MV_PAR02", ""	, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "","", "", "", ""})
	aAdd(aRegs,{cPerg,	"03","Tipo			 	?", "", "", "mv_ch3", "N", 1, 00, 1, "C", "", "MV_PAR03", "NCC"	, "", "", "", "", "NDF"	, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "","", "", "", ""})
	
	SHA_CriaX1(cPerg, aRegs)
	*/
EndIf  
/*
Pergunte("NCCNDF",.F.)
...
SetRegua(Val(mv_par02)-Val(mv_par01))
	...
	For nPage :=1 to 3          // comando para imprimir o numero de vias declarado 
		...
		oPrint:Say( 610,1285,Alltrim(GetMv("MV_DISTRIB")),oFont6)

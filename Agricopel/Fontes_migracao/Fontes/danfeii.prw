...
#DEFINE MAXMENLIN  110//080                                               // Máximo de caracteres por linha de dados adicionais
//AGRICOPEL FIM		   
...
private oRetNF// Agricopel - Retira acentos Atualizado pela TOTVS
...
For nX := 1 To nForTo
	IF cEmpAnt == '16'  // Customização Agricopel, especifico para exibição do nome da Luparco.
		oDanfe:Say(nLinCalc,098,SubStr(cStrAux,Iif(nX==1,1,((nX-1)*22)+1),22), oFont12N:oFont )
	ELSE

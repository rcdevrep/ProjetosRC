...
±±³Fun‡…o    ³ CTBX400  ³ Autor ³ Pilar S. Albaladejo   ³ Data ³ 05.02.01 ³±±
...
User Function CTBX400(	cContaIni, cContaFim, dDataIni, dDataFim, cMoeda, cSaldos,;
...
If cTipo == "1"			// Razao por Conta
	cChave   := "DESC01+CONTA+DTOS(DATAL)+LOTE+SUBLOTE+DOC+LINHA+EMPORI+FILORI"

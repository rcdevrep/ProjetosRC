...
User Function AGX435()
	...
	if CarCapaNota(mv_par02)
		...
		if Len(AllTrim(mv_par06)) == 2
			cPrefixoAlteracao := xFilial("SF1") + Substr(AllTrim(mv_par06), 2, 3)
		Else
			cPrefixoAlteracao := xFilial("SF1") + Substr(AllTrim(mv_par06), 1, 3)
		EndIf
...
Static Function CriarPerg()
	...
	AADD(aRegistros,{cPerg,"02","Serie            ?","mv_ch2","C",TamSX3("F1_SERIE")[1],0,0,"G","","mv_par02","","","","","","","","","","","","","","",""})
	...
	AADD(aRegistros,{cPerg,"06","S้rie Altera็ใo  ?","mv_ch6","C",TamSX3("F1_SERIE")[1],0,0,"G","","mv_par06","","","","","","","","","","","","","","",""})

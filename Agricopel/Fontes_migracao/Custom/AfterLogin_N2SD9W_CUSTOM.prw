...
Esta função deve ser compilada somente nos RPOs N2SD9W_CUSTOM (Não Shell) e similares
...
User Function AfterLogin()
    ...
    Local cTitMsg := "Erro de incompatibilidade - AfterLogin_N2SD9W_CUSTOM.prw"
    ...
    If !("CUSTOM" $ Upper(cAmb))
        ...
        cMsg += CRLF
        cMsg += "Esta validacao permite apenas logar em ambientes custom (N2SD9W_CUSTOM e similares) "
        cMsg += CRLF

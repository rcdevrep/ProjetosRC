...
//	xcPrefixo  := Alltrim(SM0->M0_CODFIL)+'2'
//Endif
xcPrefixo  := Alltrim(SM0->M0_CODFIL)+'3' // Alterado para pegar Serie 3 na montagem do prefixo, devido NF-e . Feito Deco 10/06/2008.
If SM0->M0_CODIGO == "02"  
	xcPrefixo  := Alltrim(SM0->M0_CODFIL)+'3'
Endif
xcTipo1    := 'CH'

...
Static Function MontaQuery
	...
	cQuery += " INNER JOIN "+RetSqlName('SA2')+" SA2 (NOLOCK) ON SA2.A2_FILIAL = '"+xFilial("SA2")+"' AND SC7.C7_FORNECE =  SA2.A2_COD     AND SA2.D_E_L_E_T_ = '' AND  SC7.C7_LOJA = SA2.A2_LOJA  "
	cQuery += " LEFT JOIN "+RetSqlName('SA5')+" SA5 (NOLOCK) ON SA5.A5_FILIAL = '"+xFilial("SA5")+"'  AND SC7.C7_PRODUTO =  SA5.A5_PRODUTO AND SC7.C7_FORNECE =  SA5.A5_FORNECE AND SC7.C7_LOJA = SA5.A5_LOJA AND SA5.D_E_L_E_T_ = '' "
	cQuery += " LEFT JOIN "+RetSqlName('SE4')+" SE4 (NOLOCK) ON SE4.E4_FILIAL = '"+xFilial("SE4")+"'  AND SC7.C7_COND    =  SE4.E4_CODIGO  AND SE4.D_E_L_E_T_ = '' "
	cQuery += " INNER JOIN "+RetSqlName('SB1')+" SB1 (NOLOCK) ON SB1.B1_FILIAL = '"+xFilial("SB1")+"' AND SC7.C7_PRODUTO =  SB1.B1_COD     AND SB1.D_E_L_E_T_ = '' "
...
Static Function AjustaSX1()
	...
	AADD(aRegs,{cPerg,"02","Até o Fornecedor ?","mv_ch2","C",06,0,0,"G","","mv_par02","","","","","","","","","","","","","","","SA2",""})
	AADD(aRegs,{cPerg,"03","Do Pedido        ?","mv_ch3","C",06,0,0,"G","","mv_par03","","","","","","","","","","","","","","","SC7",""})
	AADD(aRegs,{cPerg,"04","Até o Pedido     ?","mv_ch4","C",06,0,0,"G","","mv_par04","","","","","","","","","","","","","","","SC7",""})
	AADD(aRegs,{cPerg,"05","Da Emissão       ?","mv_ch5","D",08,0,0,"G","","mv_par05","","","","","","","","","","","","","","",""})
	AADD(aRegs,{cPerg,"06","Até Emissão      ?","mv_ch6","D",08,0,0,"G","","mv_par06","","","","","","","","","","","","","","",""})
	AADD(aRegs,{cPerg,"07","Tipo de Impressão?","mv_ch7","N",01,0,1,"C","","mv_par07","","","","","","","","","","","","","","",""})

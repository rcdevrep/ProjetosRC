...
Static Function CarregarCapa()
	...
	cQuery += " FROM " + RetSqlName("SF1") + " SF1 (NOLOCK), " + RetSqlName("SA1") + " SA1 (NOLOCK) "
...
Static Function CarregarItens()
	...
	cQuery += " FROM " + RetSqlName("SD1") + " SD1 (NOLOCK), " + RetSqlName("SB1") + " SB1 (NOLOCK) "
...
Static Function MontarItens()
	...
	For nX := 1 to Len(aFields)
		If (cAliasSX3)->(DbSeek(aFields[nX]))

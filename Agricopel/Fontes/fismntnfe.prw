...
User Function fismntnfe()
    ...
    Local nLote		 := aNfeInf[1][1]
    Local dDataLote	 := aNfeInf[1][2]
    Local cHoraLote	 := aNfeInf[1][3]
    Local nReciboSef := aNfeInf[1][4] 
    Local cCodEnvLot := aNfeInf[1][5]
    Local cMsgEnvLot := aNfeInf[1][6]
    Local cCodRet	 := aNfeInf[1][7]
    Local cMsgRet    := aNfeInf[1][8]
    Local cCodRetNfe := aNfeInf[1][9]
    Local cMsgRetNfe := aNfeInf[1][10]
    
    GOXAddXML(cIdNfe, cCodRetNfe)
    
Return

Static Function GOXAddXML(cIdNfe, cCodRetNfe)
...
Static Function TransfXML(cIdNfe)
    ...
    Local cIdEnt   :=  getCfgEntidade() //GetIdEnt() //StaticCall(SPEDNFE, GetIdEnt)
    Local cCGCCli
    Local cXML     := ""
    Local cChvCan  := ""
    Local cChvInu  := ""

...
aAdd( aSX3, { ;
	{ 'SE4'																	, .T. }, ; //X3_ARQUIVO
	{ '32'																	, .T. }, ; //X3_ORDEM
	{ 'E4_XCODOBC'															, .T. }, ; //X3_CAMPO
	{ 'C'																	, .T. }, ; //X3_TIPO
	{ 100																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Código OBC'															, .T. }, ; //X3_TITULO
	{ 'Código OBC'															, .T. }, ; //X3_TITSPA
	{ 'Código OBC'															, .T. }, ; //X3_TITENG
	{ 'Código no Portal OBC'												, .T. }, ; //X3_DESCRIC
	{ 'Código no Portal OBC'												, .T. }, ; //X3_DESCSPA
	{ 'Código no Portal OBC'												, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
